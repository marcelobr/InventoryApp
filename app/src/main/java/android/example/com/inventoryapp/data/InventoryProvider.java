...
public class InventoryProvider extends ContentProvider {
    ...
    static {
        sUriMatcher.addURI(InventoryAppContract.CONTENT_AUTHORITY, InventoryAppContract.PATH_INVENTORYAPP, PRODUCTS);

        sUriMatcher.addURI(InventoryAppContract.CONTENT_AUTHORITY, InventoryAppContract.PATH_INVENTORYAPP + "/#", PRODUCT_ID);
    }
